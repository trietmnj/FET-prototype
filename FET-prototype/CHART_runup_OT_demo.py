...
lcs_mat = 'Deer_Island_Alternative_A_Performance_LCS_project_forcing.mat'
# Define Stage Volume Relationship File
s_v_file = 'dummy_stage_vol.csv'
...
for ii in range(n_lc):
    # print debugging log with LC number and the total
    print(f"Processing LC: {ii} of {n_lc}")
